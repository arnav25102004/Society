  ...
  async function handleVerify() {
    ...
    try {
      ...
      if (data.isNewUser || data.memberships.length === 0) {
        // New user or has no society yet — go to society selection
        navigation.navigate('SocietySelect');
      }
      // If user has approved memberships, RootNavigator will auto-redirect to App
    } catch (err: any) {
      ...
      <View style={styles.content}>
        ...
        <View style={styles.resendRow}>
          ...
          <Pressable onPress={handleResend} disabled={resendSeconds > 0}>
            <Text style={[styles.resendBtn, resendSeconds > 0 && styles.resendDisabled]}>
